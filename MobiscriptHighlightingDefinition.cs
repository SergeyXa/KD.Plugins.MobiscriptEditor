...
namespace KD.Plugins.MobiscriptEditor
{
    ...
    {
        public class MobiscriptHighlightingDefinition : IHighlightingDefinition
        {
            public static Dictionary<string /*keyword*/, string /*desc*/> Keywords;

            static MobiscriptHighlightingDefinition()
            {
                Keywords = new Dictionary<string, string>();

                foreach(var textLine in MobiscriptEditor.Properties.Resources.Keywords
            ...
            public MobiscriptHighlightingDefinition()
            {
